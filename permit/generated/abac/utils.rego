...
__user_attributes = merge_objects(
	merge_objects(
		merge_objects(__generated_user_attributes, __stored_user_attributes),
		__custom_user_attributes,
	),
	__input_user_attributes,
)

__resource_attributes = merge_objects(
	merge_objects(__generated_resource_attributes, __custom_resource_attributes),
	__input_resource_attributes,
)

__tenant_attributes = merge_objects(
	merge_objects(__stored_tenant_attributes, __custom_tenant_attributes),
	__input_tenant_attributes,
)

__context_attributes = merge_objects(
